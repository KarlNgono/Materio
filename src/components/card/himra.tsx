...
export default function Himra() {
  useTheme()

  const tracks = [
    { id: 1, title: 'CA GLOW', src: '/images/audios/1_1 - CA GLOW - Himra (320).mp3' },
    { id: 2, title: 'DONKEY KONG', src: '/images/audios/1_4 - DONKEY KONG - Himra (320).mp3' },
    {
      id: 3,
      title: 'C\'EST PAS DE MA FAUTE',
      src: '/images/audios/1_5 - C\'EST PAS DE MA FAUTE - Himra (320).mp3'
    },
    { id: 4, title: 'TIENS MA MONEY feat (STONEBWOY)', src: '/images/audios/1_12_TIENS_MA_MONEY_feat_Stonebwoy_Himra_Stonebwoy_320.mp3' },
    { id: 5, title: 'LIL WAYNE', src: '/images/audios/1_13 - LIL WAYNE - Himra (320).mp3' }
  ]
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            <CardContent sx={{ p: 1 }}>
              <Typography variant='subtitle1' sx={{ fontWeight: 'bold', fontSize: 14 }}>
                DACHIBA KOUMGBA TCHAIBA
              </Typography>
              <List
                sx={{ width: '100%', bgcolor: 'background.paper', p: 0 }}
                component='nav'
                subheader={<ListSubheader sx={{ fontSize: 12, lineHeight: 1.5 }}>Himra</ListSubheader>}
              >
                {tracks.map(track => (
